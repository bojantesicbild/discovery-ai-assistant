...
async def list_tools() -> list[Tool]:
    return [
        ...
        Tool(name="get_stakeholders", description="Get all identified stakeholders with roles and decision authority (final/recommender/informed). Use when you need to know who to ask about what.", inputSchema={"type": "object", "properties": {"project_id": {"type": "string"}}, "required": ["project_id"]}),
